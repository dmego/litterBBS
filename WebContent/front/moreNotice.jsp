			...
			<div class="user-right-n clearfix">
				<ul id="right-tab" class="nav nav-tabs">
					<li role="presentation" class="active"><a id="home-tab1"
						data-toggle="tab"><i class="fa fa-book"></i>&nbsp;全部公告</a></li>
				</ul>
					...
					<div role="tabpanel" class="tab-pane active" id="myArticle">
						<div class="tab-pane active" id="home">
							<section id="LastestPostList"
								...
								items="${moreNoticeList }" var="item" varStatus="status">
								<div class="media">
									<a class="pull-left"
										href="${pageContext.request.contextPath}/front/userServlet?method=comment&userid=${item.userid}">
										<img class="media-object avatar avatar-sm"
										src="${item.usericon }">
									</a>
									<div class="comment">
										<div class="comment-author h6 no-margin">
											<a href="${pageContext.request.contextPath}/front/noticeFServlet?method=showNotice&noticeid=${item.noticeid}">${item.title}</a>
										</div>
										<div class="comment-bt"> <strong><a
