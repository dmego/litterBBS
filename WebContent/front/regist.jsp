...
<body onload="createCode()">
	...
	<div class="bottom"
		style="position: absolute; bottom: 0px; margin-top: 20px; background-color: rgba(0, 0, 0, 0.8); width: 100%; height: 75px; color: darkgray">
		<div
			style="width: 400px; padding-top: 15px; padding-left: 40px; padding-right: 40px; margin: auto;">
			<div align="center">
