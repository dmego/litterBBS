	...
	<div class="crumb-wrap">
		<div class="crumb-list">
			<i class="icon-font-1"></i><a href="../mainIndex.jsp">首页</a> <span
				class="crumb-step">&gt;</span><span class="crumb-name">版区信息操作</span>
		</div>
	</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<c:if test="${updateBean!=null}">
							<h3 class="panel-title">修改版区</h3>
						</c:if>
						<c:if test="${updateBean==null}">
							<h3 class="panel-title">新增版区</h3>
						</c:if>
						
					</div>
					<div class="panel-body">
						<div class="column">
							<form action="${pageContext.request.contextPath }/admin/type/typeServlet?method=addType&updateId=${updateBean.typeid}" method="post">
								<div class="form-group">
									<label for="name">版区名称</label> 
